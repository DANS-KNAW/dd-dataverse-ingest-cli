...
@Command(name = "convert-dans-import-bag",
         mixinStandardHelpOptions = true,
         description = "Converts one or more deposits containing DANS import/SWORD bags to ones that contain Dataverse ingest bags")
@RequiredArgsConstructor
public class ConvertDansImportBag implements Callable<Integer> {
    @NonNull
